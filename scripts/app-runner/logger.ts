...
function rendererLog(data: any, color: string): void { printLog('Renderer', data, color); }
function electronLog(data: any, color: string): void { printLog('Electron', data, color); }
function runnerLog(data: any, color: string): void { printLog('Runner', data, color); }
